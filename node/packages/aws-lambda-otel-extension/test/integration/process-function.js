  ...
  do {
    ...
    for (const { message } of events) {
      ...
      if (message.startsWith('REPORT RequestId: ')) {
        ...
        currentInvocationData.billedDuration = reportData.billedDuration;
        currentInvocationData.duration = reportData.duration;
        currentInvocationData.maxMemoryUsed = reportData.maxMemoryUsed;
        if (reportData.initDuration) currentProcessData.initDuration = reportData.initDuration;
